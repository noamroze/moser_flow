...
class Flags:
    def __init__(self):
        self.parser = argparse.ArgumentParser(
            description="Graph Convex Potential Networks"
        )
        self.add_core_args()
    ...
    def add_core_args(self):
        ...
        self.parser.add_argument(
            ...
            required=True,
            help="Whether to train the model or validate pretrained model",
        )
        self.parser.add_argument(
            "--config-yml",
            required=False,
        ...
        self.parser.add_argument(
            "--continue_saved",
            action="store_true",
            help="continue a saved experiment if exists"
        )
        self.parser.add_argument(
            "--only_save_checkpoints",
            action="store_true",
            help="only save checkpoints and do not plot evaluations"
        )
